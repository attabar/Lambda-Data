...
<div class="container">
    ...
    <div class="content">
        ...
        <div class="main-content">
            <marquee behavior="" direction="">This is the only avalailable bank we have for now that is wema bank</marquee>
            <!-- account -->
            <div class="account-details">
                <!-- wema bank logo img-->
                <img src="../img/wemaBankLogo.jpeg" class="wemaImg" alt="" srcset="">
                <h3>Account Number: <span id="accNum"></span></h3><br>
                <h3>Account Name: <span id="accName"></span><span class="chargesAmount">  ₦50<br>Charges</span></h3><br>
            ...
            <div class="account-status">
                <div class="account-container"><button><i class="bi bi-plus-lg"></i> Fund Wallet</button><button><i class="bi bi-plus-lg"></i> Upgrade Account</button></div>
