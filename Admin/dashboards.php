    ...
    <div class="sidebar">
        ...
        <div class="sidebar-content">
            <ul>
                ...
                <!-- submenu for prices -->
                <ul class="submenu">
                    <li><a href="./set_data_price.php"><i class="bi bi-arrow-right-short"></i>Update Price</a></li>
                    <li><a href="addnew.php"><i class="bi bi-arrow-right-short"></i>Create Price</a></li>
                </ul>
                </li>
